				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Equipment List &nbsp;&nbsp;<button class="btn btn-success" name="submit" type="submit" onclick="return window.location.assign('./add-equipment.php');">Add Equipment</button> </div>
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->license_no);?></td>
