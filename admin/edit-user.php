...
//usertype
	...
	$sql="UPDATE users SET name=(:name), email=(:email), gender=(:gender), mobile=(:mobileno), designation=(:designation), Image=(:image) , user_type=(:usertype) WHERE id=(:idedit)";
...
<div class="col-sm-4">
<select name="gender" class="form-control" required value="<?php echo htmlentities($result->gender);?>">
                            <option value=""> </option>
...
<select name="usertype" class="form-control" required >
                            ...
                            <option value="guard" <?php if($result->user_type == "guard"){ echo "selected";}?>>Guard</option>
                            <option value="manager" <?php if($result->user_type == "manager"){ echo "selected";}?>>Manager</option>
