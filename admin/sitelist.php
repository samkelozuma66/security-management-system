			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Site List</h2>
...
{				?>	
										<tr>
											...
											<td><img src="../images/<?php echo htmlentities($result->avatar);?>" style="width:50px; border-radius:50%;"/></td>
                                            <td><?php echo htmlentities($result->site_name);?></td>
                                            <td><?php echo htmlentities($result->manager_name);?></td>
                                            <td><?php echo htmlentities($result->manager_email);?></td>
...
<a href="manage-site.php?site=<?php echo $result->id;?>" onclick=""><i class="fa fa-suitcase" style="color:green"></i></a>&nbsp;&nbsp;
</td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
